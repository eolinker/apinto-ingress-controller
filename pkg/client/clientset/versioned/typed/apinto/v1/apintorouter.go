...
// ApintoRoutersGetter has a method to return a ApintoRouterInterface.
...
// apintoRouters implements ApintoRouterInterface
type apintoRouters struct {
	client rest.Interface
	ns     string
}

// newApintoRouters returns a ApintoRouters
func newApintoRouters(c *ApintoV1Client, namespace string) *apintoRouters {
	return &apintoRouters{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *apintoRouters) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ApintoRouter, err error) {
	result = &v1.ApintoRouter{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apintorouters").
		Name(name).
...
func (c *apintoRouters) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ApintoRouterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ApintoRouterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apintorouters").
...
func (c *apintoRouters) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apintoRouters) Create(ctx context.Context, apintoRouter *v1.ApintoRouter, opts metav1.CreateOptions) (result *v1.ApintoRouter, err error) {
	result = &v1.ApintoRouter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apintorouters").
...
func (c *apintoRouters) Update(ctx context.Context, apintoRouter *v1.ApintoRouter, opts metav1.UpdateOptions) (result *v1.ApintoRouter, err error) {
	result = &v1.ApintoRouter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apintorouters").
		Name(apintoRouter.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apintoRouter).
		Do(ctx).
		Into(result)
...
func (c *apintoRouters) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *apintoRouters) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *apintoRouters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ApintoRouter, err error) {
	result = &v1.ApintoRouter{}
