...
var apintoservicesResource = schema.GroupVersionResource{Group: "apinto.com", Version: "v1", Resource: "apintoservices"}

var apintoservicesKind = schema.GroupVersionKind{Group: "apinto.com", Version: "v1", Kind: "ApintoService"}
...
func (c *FakeApintoServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *apintov1.ApintoService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(apintoservicesResource, c.ns, name), &apintov1.ApintoService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*apintov1.ApintoService), err
}
...
func (c *FakeApintoServices) List(ctx context.Context, opts v1.ListOptions) (result *apintov1.ApintoServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(apintoservicesResource, apintoservicesKind, c.ns, opts), &apintov1.ApintoServiceList{})
	...
	list := &apintov1.ApintoServiceList{ListMeta: obj.(*apintov1.ApintoServiceList).ListMeta}
	for _, item := range obj.(*apintov1.ApintoServiceList).Items {
...
func (c *FakeApintoServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(apintoservicesResource, c.ns, opts))
...
func (c *FakeApintoServices) Create(ctx context.Context, apintoService *apintov1.ApintoService, opts v1.CreateOptions) (result *apintov1.ApintoService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(apintoservicesResource, c.ns, apintoService), &apintov1.ApintoService{})
...
func (c *FakeApintoServices) Update(ctx context.Context, apintoService *apintov1.ApintoService, opts v1.UpdateOptions) (result *apintov1.ApintoService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(apintoservicesResource, c.ns, apintoService), &apintov1.ApintoService{})
...
func (c *FakeApintoServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(apintoservicesResource, c.ns, name, opts), &apintov1.ApintoService{})
...
func (c *FakeApintoServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apintoservicesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &apintov1.ApintoServiceList{})
	return err
}
...
func (c *FakeApintoServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *apintov1.ApintoService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(apintoservicesResource, c.ns, name, pt, data, subresources...), &apintov1.ApintoService{})
